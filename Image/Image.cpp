...
//	ON_COMMAND(ID_LINETRANS, &CAboutDlg::OnLinetrans)
//ON_COMMAND(ID_HISTOGRAM, &CAboutDlg::OnHistogram)
//ON_COMMAND(ID_FOURIER, &CAboutDlg::OnFourier)
//ON_UPDATE_COMMAND_UI(ID_FOURIER, &CAboutDlg::OnUpdateFourier)
END_MESSAGE_MAP()
